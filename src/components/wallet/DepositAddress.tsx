...
export const DepositAddress: React.FC = () => {
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-6">
      <h3 className="text-xl font-bold text-gray-800 mb-4">Deposit Bitcoin</h3>
      ...
      <div className="space-y-4">
        ...
        {generatedAddress && (
          <div className="bg-green-50 border border-green-200 rounded-lg p-4">
            <p className="text-green-800 font-medium mb-2">✓ Deposit Address Generated!</p>
            <div className="bg-white rounded p-3 break-all text-sm font-mono text-gray-800">
              {generatedAddress}
            </div>
        ...
        <div className="border-t pt-4">
          <h4 className="text-sm font-semibold text-gray-700 mb-3">Claim Deposit</h4>
          <div className="space-y-3">
            <div>
              <label htmlFor="deposit-txid" className="block text-sm font-medium text-gray-700 mb-1">
                Transaction ID
              </label>
              <input
                id="deposit-txid"
        ...
        <div className="border-t pt-4">
          <div className="flex justify-between items-center mb-3">
            <h4 className="text-sm font-semibold text-gray-700">Unused Addresses</h4>
            <button
            ...
            <div className="space-y-2 max-h-40 overflow-y-auto">
              {depositAddresses.map((address, index) => (
                <div key={index} className="flex justify-between items-center p-2 bg-gray-50 rounded text-sm">
                  <span className="text-gray-800 font-mono truncate mr-2">{address}</span>
                  <button
          ...
          {showUnused && depositAddresses.length === 0 && (
            <p className="text-sm text-gray-500">No unused addresses found.</p>
          )}
        </div>
      </div>
    </div>
